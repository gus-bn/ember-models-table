...
import ColumnsDropdown from '../../components/models-table/themes/skodash/columns-dropdown';
import DataGroupBySelect from '../../components/models-table/themes/skodash/data-group-by-select';
import GlobalFilter from '../../components/models-table/themes/skodash/global-filter';
import RowFilteringCell from '../../components/models-table/themes/skodash/row-filtering-cell';
import Summary from '../../components/models-table/themes/skodash/summary';
import PageSizeSelect from '../../components/models-table/themes/skodash/page-size-select';
import PaginationSimple from '../../components/models-table/themes/skodash/pagination-simple';
import PaginationNumeric from '../../components/models-table/themes/skodash/pagination-numeric';
...
export default class SkodashTheme extends DefaultTheme {
  /**
   * @default 'models-table/themes/skodash/columns-dropdown'
   */
  ...
  /**
   * @default 'models-table/themes/skodash/data-group-by-select'
   */
  ...
  /**
   * @default 'models-table/themes/skodash/global-filter'
   */
  ...
  /**
   * @default 'models-table/themes/skodash/row-filtering-cell'
   */
  ...
  /**
   * @default 'models-table/themes/skodash/summary'
   */
  ...
  /**
   * @default 'models-table/themes/skodash/page-size-select'
   */
  ...
  /**
   * @default 'models-table/themes/skodash/pagination-simple'
   */
  ...
  /**
   * @default 'models-table/themes/skodash/pagination-numeric'
   */
...
declare module '@ember/service' {
  interface Registry {
    'emt-themes/skodash': SkodashTheme;
  }
}
